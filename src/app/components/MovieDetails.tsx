    ...
    <section className="px-8 py-12">
      <div className="flex flex-col md:flex-row items-start md:space-x-8">
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="mt-6 flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
            <button className="bg-black hover:bg-purple-700 text-white py-2 px-6 rounded flex items-center justify-center w-full sm:w-auto">
              <i className="fas fa-play mr-2 w-5 h-4"></i> Watch Trailer
            </button>

            <Link href={`/${MovieID}/ticketbooking`}>
              <button className="bg-black hover:bg-purple-700 text-white px-4 py-2 rounded w-full sm:w-auto">
            ...
            <button
              ...
              className="bg-black hover:bg-purple-700 text-white py-2 px-6 rounded flex items-center justify-center w-full sm:w-auto"
            >
          ...
          <div className="mt-12">
            ...
            <div className="flex flex-wrap space-x-4 md:space-x-4">
              {reviews.length > 0 ? (
                reviews.map((review, index) => (
                  <div
                    key={index}
                    className="card-bg text-white rounded-lg shadow-lg p-6 flex flex-col justify-between border border-white w-full sm:w-1/2 lg:w-1/3"
                  >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-full sm:w-1/3">
